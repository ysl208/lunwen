In this chapter we demonstrate the generalisability of our chosen PbD approach using keyframe-based demonstration (\cite{akgun12klfd}), and its usability for end-user robot programming applications.
...
As the system includes an implementation of both a state-of-the-art PbD approach and a graphical user interface to facilitate end-user robot programming, it builds a firm foundation for the framework proposed in \chapt{chap:Contribution}.
