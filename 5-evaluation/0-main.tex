...
In the previous chapter (\chapt{chap:Contribution}) we proposed iRoPro, an interactive Robot Programming framework that allows end-users to teach robots new actions by demonstration, that can be reused with task planners to complete previously unseen tasks.
