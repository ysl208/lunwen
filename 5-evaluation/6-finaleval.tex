...
Users were given 8 tasks to complete, where the first two were practice tasks to introduce them to the system (Table \ref{table:user_study_tasks}). 
...
\begin{figure}[t]%
  \centering
    \includegraphics[width=0.8\columnwidth]{figures/quan-pretest-results.pdf}%
