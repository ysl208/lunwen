...
\begin{figure*}
	...
	\caption{User responses from the post-study survey (N=20) comparing iRoPro to our previous user study (N=11) in \sect{sec:Exp2}}
...
\begin{enumerate}
	...
	\item {Pre-tests with 3 users:\\
		...
		We also made the user interface more friendly to include Baxter icons (\fig{?}) and display eyes on the robot's screen \footnote{https://github.com/Anne-Gaisne/baxter_eyes} so that it seemed more human-like.
