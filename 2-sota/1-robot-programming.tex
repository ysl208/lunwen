...
Unlike ML solutions, Programming by Demonstration (PbD) (\cite{billard2008robot}), learns from \textit{biased} data in the form of demonstrations provided by a human teacher.
...
The user can choose to provide positive or negative examples (\cite{grollman2012robot}), to allow the robot to learn more efficiently.
